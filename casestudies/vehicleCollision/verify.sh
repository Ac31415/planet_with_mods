...
python ../../tools/caffemodel2json.py /tmp/tmpYd1Jh4/caffe.proto $latest --data > testNetworkWithPooling.json
# python ../../tools/caffemodel2json.py /tmp/tmpYd1Jh4/caffe_pb2.py $latest --data > testNetworkWithPooling.json
